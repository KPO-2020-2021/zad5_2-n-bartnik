...
void Drone::obrot_rotrow()
{
    ...
    Matrix3x3 nowa;
    nowa = nowa * macierz_obrot_z(kat);//wokół osi OZ
    for (int i = 0; i < 4; i++)
    {
...
void Drone::sterowanie()
{
    ...
    case 'p':
        ...
        for (int i = 0; i < 100; i++)
        {
            ...
            animacja(1); //przesunięcie - animacja o 1
           obrot_rotrow();
            zapisz();
            Lacze.Rysuj();
...
/*!
    ...
    *Do współrzędniej Z przypisuje wartość 150 i wstawia tę współrzędną na koniec listy. Współrzędne X, Y oblicza na podstawie wzoru podanego w treści zadania i również wstawia do kontenera wektora. 
    *Następnie zeruje współrzędną Z i wstawia ją do kontenera wektorów.
